...
class myApp(ShowBase):
    ...
    def Scene(self):
        ...
        #########################Universe Rendering################################################ 
        self.Universe = Spacejamclasses.Planet(self.loader, "./Assets/Universe/Universe.x", self.render, 'Universe', "./Assets/Universe/Universe.jpg", (0, 0, 0), 10000)
        ...
        self.Player = Spacejamclasses.Player(self.loader, "./Assets/Player/hornetMini.x", self.render, 'Player', "./Assets/Player/hornetMini.jpg", (-4000, -2000, 67), 50)
